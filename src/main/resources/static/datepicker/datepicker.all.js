...
$(function () {
  ...
  var API = {
    ...
    getTimeFormat: function (_moment) {
   		//console.log("字符串:"+_moment);
   		//console.log("getTimeFormat.return:year:"+ _moment.year()+",month:"+(_moment.month() +1)+",day:"+_moment.date());
	    return {
		    year: _moment.year(),
    ...
    newDateFixed: function (_this,temp){
      ...
      //console.log("newDateFixed.temp："+temp);
      //console.log(_this);
      //console.log("Time:"+reg);
      if(_this.config.format === "YYYY"){
      	//var data = temp?new Date(reg):new Date();
      	//var aa = new Date(temp) ;
      	//console.log("newDateFixed.return:"+aa.getFullYear());
