;(function($, window, document,undefined) {
    ...
    Drag_.prototype = {
        run: function() {
					...
					$('.drag').mouseup(function(e){fun.dragEnd(parseInt(element.css('left')),parseInt(element.css('top')));element.removeClass('on');isDown = false;});
    ...
    //插件
    $.fn.myDrag_ = function(options) {
        //创建实体
        var drag_ = new Drag_(this, options);
        //调用方法
        drag_.run();
		return this;
    }
