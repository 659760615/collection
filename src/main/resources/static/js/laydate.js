...
! function() {
	...
	C.prototype = [], C.prototype.constructor = C, w.extend = function() {
		...
		var t, a, i = this,
			...
			l = (i.isInput(s) ? "val" : "html", i.isInput(s) ? s.value : "statics" === r.position ? "" : s.innerHTML),
			c = function(e) {
		...
		return "statics" === n.position || w(a)[i](e || ""), this
		...
		if(r = {
			...
			} else "statics" === n.position ? (l(!0), t.calendar().done().done(null, "change")) : "date" === n.type ? (l(!0), t.setValue(t.parse()).remove().done()) : "datetime" === n.type && (l(!0), t.calendar().done(null, "change"))
	}, T.prototype.tool = function(e, t) {
		var n = this,
			a = n.config,
			i = a.dateTime,
			r = "statics" === a.position,
			o = {
				datetime: function() {
